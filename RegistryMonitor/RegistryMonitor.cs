...
namespace RegistryUtils
{
  ...
  public class RegistryMonitor : IDisposable
  {
    ...
    /// </summary>
    public event EventHandler<RegChangedEventArgs> RegChanged;
    ...
    {
      EventHandler<RegChangedEventArgs> handler = RegChanged;
      if (handler != null)
      {
        RegChangedEventArgs args = new RegChangedEventArgs { ID = ID, RegistryKey = RegistryKey };
        handler(this, args);
      }
    }
